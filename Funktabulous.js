window.onload= function start ()
{
	...
	var randColour;
    var randHeight;
	var star = paper.path("M375,300 L400,250 L425,300 L480,300 L440,340 L455,400 L400,375 L345,400 L360,340 L320,300 L375,300").attr({stroke:"white", fill:"blue"});
	var stars = new Array(5);
	for (var i=0;i<5;i++){
		stars[i] = star;
	}
	var discoball = paper.image(src="discoball.png", 300,-251, 190,251);
